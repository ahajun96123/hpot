...
<body>
	...
	<div class="container">
		<h1>글 작성</h1>
		<form action="write" method="post" id="writeForm" onsubmit="postForm()">
			<table class="table table-bordered">
				<c:choose>
					...
					<tr>
						<th>URL</th>
						<td><input type="text" placeholder="링크를 입력하세요."
							name="bUrl" class="form-control" /></td>
					</tr>
					</c:when>
					  <c:otherwise><input type="hidden" value="http://"
							name="bUrl" class="form-control" />
					  </c:otherwise>
					</c:choose>
					<tr>
						<th>내용</th>
					...
					<tr>
						<th>태그</th>
						<td><input type="text" placeholder="#태그를 입력하세요."
							name="bTag" class="form-control" value="#"/></td>
					</tr>
					<tr>
						<td colspan="2">
							...
							<div style="margin-right:10px;float: right">
								<a class="btn btn-warning" type="button" href="history.back()">목록</a>
							</div>
						</td>
					</tr>
			</table>
